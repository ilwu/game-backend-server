module.exports = {
  ...
  PLAYER_NOT_LOGOUT: 215, // 玩家不在登出狀態
  PLAYER_NOT_FREE_OR_LOGOUT: 216, // 玩家不在登出狀態也不在空閒狀態

  ACCOUNT_SESSIONKEY_INVALID: 215, // 会话秘钥失效
  PLAYER_OUT_GOLD: 216, // 余额不足
  PLAYER_MAX_BULLETS: 217, // 最大子弹数
  PLAYER_NOT_BIND_OPENID: 218, //未绑定微信OpenId
  ACCOUNT_TRADE_EXIST: 219, //交易已经存在
  PLAYER_OUT_UPDATECANNON: 220, // 玩家更新炮台超過次數(5秒20次)
  WALLET_NOT_EXIST_OR_MULTIPLE: 221, // 玩家tokens不存在或mongo有兩個以上相同的錢包(gameId&playerId)

  PLAYER_STATE_SUSPEND: 222, // 玩家帳號被 停用
  PLAYER_STATE_FREEZE: 223, // 玩家帳號被 凍結
  PLAYER_BULLETID_DUPLICATE: 224, // 玩家子彈ID重複
  ...
  WX_GAME_NO_ENOUGH_TICKS: 801, // 奖券不足
  WX_GAME_NO_EXCHANGE_CHANCE: 802, // 没有兑奖机会

  GAME_HAS_COMPLETED: 901, // 已经完成

  REQUEST_TOO_SOON: 1001, //請求太頻繁
  API_AUTH_FAIL: 2001, //API驗證失敗
}
